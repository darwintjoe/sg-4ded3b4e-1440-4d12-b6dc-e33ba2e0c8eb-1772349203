  ...
  const handleChangeAdminPin = async () => {
    if (!currentPin || !newPin || !confirmPin) {
      toast({
        ...
        description: translate("error.required", language),
        variant: "destructive",
      });
      return;
    }
    ...
    if (newPin !== confirmPin) {
      toast({
        title: translate("common.error", language),
        description: translate("settings.security.pinMismatch", language),
        variant: "destructive",
      });
      return;
    }
    ...
    if (!isValid) {
      toast({
        title: translate("common.error", language),
        description: translate("settings.security.pinInvalid", language),
        variant: "destructive",
      });
      return;
    }
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} defaultValue="store" className="flex-1 flex flex-col">
        ...
        <div className="flex flex-col">
          <div>
            <TabsContent value="store" className="h-[calc(100vh-120px)] overflow-y-auto space-y-4 p-4 mt-0">
          ...
          <TabsContent value="pos" className="h-[calc(100vh-120px)] overflow-y-auto space-y-4 p-4 mt-0">
            <POSSettingsSection 
              settings={settings} 
              onUpdate={updateAndSave}
              language={language}
          ...
          <TabsContent value="backup" className="h-[calc(100vh-120px)] overflow-y-auto space-y-4 p-4 mt-0">
          ...
          <TabsContent value="database" className="h-[calc(100vh-120px)] overflow-y-auto space-y-4 p-4 mt-0">
