...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    "settings.pos.shift1": "Shift 1 (Morning)",
    "settings.pos.shift2": "Shift 2 (Afternoon)",
    "settings.pos.shift3": "Shift 3 (Night)",
    "settings.pos.start": "Start",
    "settings.pos.end": "End",
    "settings.pos.paymentMethods": "Payment Methods",
    "settings.pos.paymentMethodsHint": "Aktifkan opsi pembayaran untuk kasir",
    "settings.pos.payment.cash": "Tunai",
    "settings.pos.payment.card": "Kartu (Debit/Kredit)",
    "settings.pos.payment.ewallet": "E-Wallet (GoPay, OVO, Dana)",
    "settings.pos.payment.qr": "QR Code (QRIS)",
    "settings.pos.payment.transfer": "Transfer Bank",
    "settings.pos.priceOverride": "Ubah Harga",
    "settings.pos.priceOverrideHint": "Izinkan kasir mengubah harga barang saat transaksi",
    "settings.pos.taxConfiguration": "Konfigurasi Pajak",
    "settings.pos.tax1Label": "Pajak 1 (Utama)",
    "settings.pos.tax2Label": "Pajak 2 (Sekunder)",
    "settings.pos.taxRate": "Tarif (%)",
    "settings.pos.taxInclusive": "Termasuk Pajak",
  ...
  zh: {
    ...
    "settings.pos.shift1": "班次 1（早班）",
    "settings.pos.shift2": "班次 2（午班）",
    "settings.pos.shift3": "班次 3（晚班）",
    "settings.pos.start": "开始",
    "settings.pos.end": "结束",
    "settings.pos.paymentMethods": "支付方式",
    "settings.pos.paymentMethodsHint": "启用结账支付选项",
    "settings.pos.payment.cash": "现金",
    "settings.pos.payment.card": "银行卡 (借记卡/信用卡)",
    "settings.pos.payment.ewallet": "电子钱包 (GoPay, OVO, Dana)",
    "settings.pos.payment.qr": "二维码 (QRIS)",
    "settings.pos.payment.transfer": "银行转账",
    "settings.pos.priceOverride": "价格覆盖",
    "settings.pos.priceOverrideHint": "允许收银员在结账时调整商品价格",
    "settings.pos.taxConfiguration": "税收配置",
    "settings.pos.tax1Label": "税种 1 (主要)",
    "settings.pos.tax2Label": "税种 2 (次要)",
    ...
    "items.deleteItem": "Hapus Barang",
    "items.deleteConfirm": "Apakah Anda yakin ingin menghapus barang ini?",
