...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    "settings.pos.payment.cash": "Cash",
    "settings.pos.payment.card": "Card",
    "settings.pos.payment.ewallet": "E-Wallet",
    "settings.pos.payment.qr": "QR Code",
    "settings.pos.payment.transfer": "Bank Transfer",
    "settings.pos.priceOverrideHint": "Allow cashiers to modify item prices",
  ...
  id: {
    ...
    "settings.pos.payment.cash": "Tunai",
    "settings.pos.payment.card": "Kartu",
    "settings.pos.payment.ewallet": "E-Wallet",
    "settings.pos.payment.qr": "Kode QR",
    "settings.pos.payment.transfer": "Transfer Bank",
    "settings.pos.priceOverrideHint": "Izinkan kasir mengubah harga barang",
  ...
  zh: {
    ...
    "settings.pos.payment.cash": "现金",
    "settings.pos.payment.card": "卡",
    "settings.pos.payment.ewallet": "电子钱包",
    "settings.pos.payment.qr": "二维码",
    "settings.pos.payment.transfer": "银行转账",
    "settings.pos.priceOverrideHint": "允许收银员修改商品价格",
