...
export function getDefaultSettings(): Settings {
  return {
    ...
    shifts: {
      shift1: { enabled: true, name: "Morning Shift", startTime: "07:00", endTime: "14:00" },
      shift2: { enabled: true, name: "Afternoon Shift", startTime: "14:00", endTime: "21:00" },
      shift3: { enabled: false, name: "Night Shift", startTime: "21:00", endTime: "07:00" }
    },
    requireClockIn: true,
    trackBreaks: false,
    ...
    theme: "system",
    qrisStaticImage: undefined,
    qrisDynamicEndpoint: undefined,
    qrisDynamicApiKey: undefined,
    qrisDynamicMerchantId: undefined
  };
}
